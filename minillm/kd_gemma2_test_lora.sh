...
# model
BASE_PATH=${1-"/home/hyunseoki/LMOps/minillm"}
# CKPT_NAME="gemma"
# CKPT="${BASE_PATH}/test/${CKPT_NAME}/"
CKPT_NAME="google/gemma-2-2B"
CKPT="${CKPT_NAME}"
# TEACHER_CKPT_NAME="gemma"

# TEACHER_CKPT="${BASE_PATH}/test/${CKPT_NAME}/"
TEACHER_CKPT_NAME="google/gemma-2-2B"
...
MP_SIZE=2
# data
DATA_DIR="${BASE_PATH}/processed_data/${TEACHER_CKPT_NAME}/8192/20K/"
ENG_DATA_DIR="${BASE_PATH}/processed_data/${TEACHER_CKPT_NAME}/8192/english/2M/"
# hp
BATCH_SIZE=1
LR=0.00001
GRAD_ACC=4
