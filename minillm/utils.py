...
def get_model(args, device):
    ...
    if args.model_parallel:
        ...
        model = AutoModelForCausalLM.from_pretrained(args.model_path, config=config, device_map={"": device}, torch_dtype=torch.bfloat16)# ,attn_implementation='flash_attention_2',
